...
//Basic SOP Loadout script, since it is a pain in the ass to do it in Eden everytime there is a change in the SOP.
...
//Fireteam Leader (WeaponSquad)
    if (player isKindOf "rhsusf_army_ocp_arb_teamleader") then {
        [player] execVM "loadouts\FTL-WeaponSquad.sqf";
    };
